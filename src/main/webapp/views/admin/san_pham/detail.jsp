    ...
    <div class="main-content"id="content">
        ...
        <div class="content">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                <c:forEach var="spct" items="${sanPhamCTList}" varStatus="status">
                          <tr id="row-${status.index+1}">
                               ...
                               <td>${spct.kichCo}</td>
                               <td><fmt:formatNumber value="${spct.gia}" type="currency" currencySymbol="₫" /></td>
                               <td>${spct.soLuongTon}</td>
                               <td><c:choose>
                                   <c:when test="${spct.trangThai}">Còn hàng</c:when>
