...
<div class="container">
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="menu-section">
            ...
            <ul class="menu">
                ...
                <li class="active"><a href="/staff/nhan-vien/index"><i class="fas fa-users"></i> <span>Nhân Viên</span></a></li>
    ...
    <div class="main-content"id="content">
        ...
        <div class="content">
            ...
            <form action="/staff/nhan-vien/search" method="get" class="d-flex justify-content-between mb-4">
...
<script>
    ...
    function resetForm() {
        ...
        window.location.href = '/staff/nhan-vien/index';
    }
</script>
<!-- Bootstrap JS -->
