...
<div class="container">
    ...
    <div class="main-content"id="content">
        ...
        <div class="content">
            <!-- Search Form -->
            <form id="resetForm" action="/voucher/search" method="get" class="d-flex justify-content-between mb-4">
            ...
            <div class="text-end mb-3">
                ...
                <a href="/voucher/create" class="btn btn-info">Tạo voucher</a>
            </div>
            ...
            <table class="table table-hover">
                ...
                <c:forEach var="voucher" items="${vouchers}">
                    <tr>
                        ...
                        <td>
                            <a href="update/${voucher.id}" data-bs-toggle="tooltip" title="Chỉnh sửa">
                            ...
                            <a href="delete/${voucher.id}" data-bs-toggle="tooltip" title="Xóa voucher">
