...
<head>
    ...
    <title>Admin - Quản lý màu sắc</title>
...
<div class="container">
            ...
            <ul class="menu">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="active"><a href="/mau-sac/index"><i class="fa-solid fa-palette"></i><span>Màu sắc</span></a></li>
    ...
    <div class="main-content"id="content">
        ...
        <div class="content">
            ...
            <form action="/mau-sac/search" method="get" class="d-flex justify-content-between mb-4">
                <div class="flex-grow-1 pe-2">
                    <input type="text" name="tenMS" class="form-control" placeholder="Nhập màu sắc bạn cần tìm">
                </div>
                ...
                <c:forEach items="${data}" var="ms">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="delete/${ms.idMS}" data-bs-toggle="tooltip" title="Xóa màu này">
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center">
                        <c:if test="${currentPage > 1}">
                            <a href="?page=${currentPage - 1}&size=10&tenMS=${tenMS}">Trước</a>
                        </c:if>
                        <c:forEach begin="1" end="${totalPages}" var="i">
                            <a href="?page=${i}&size=10&tenMS=${tenMS}&"
                               class="${i == currentPage ? 'active' : ''}">
                                    ${i}
                            </a>
                        </c:forEach>
                        <c:if test="${currentPage < totalPages}">
                            <a href="?page=${currentPage + 1}&size=10&tenMS=${tenMS}">Tiếp</a>
                        </c:if>
                    </ul>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/mau-sac/add" method="post">
                        <div class="mb-3">
                            <label for="tenMS-add" class="form-label">Tên màu</label>
                            <input type="text" class="form-control" id="tenMS-add" name="tenMS" required>
                        </div>
...
<div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateModalLabel">Cập nhật màu sắc</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="updateForm" method="post" action="/mau-sac/update${idMS}">
                    <input type="hidden" id="updateId" name="idMS">
                    <div class="mb-3">
                        <label for="tenMS" class="form-label">Tên màu</label>
                        <input type="text" class="form-control" id="tenMS" name="tenMS" required>
                    </div>
...
<script>
    ...
    function resetForm() {
        document.querySelector('input[name="tenMS"]').value = '';

        window.location.href = '/mau-sac/index';
    }
    document.addEventListener("DOMContentLoaded", function () {
    ...
    updateButtons.forEach(function (button) {
        button.addEventListener('click', function () {
            var idMS = button.getAttribute('data-id');
            var tenMS = button.getAttribute('data-tenMS');

            document.getElementById('updateId').value = idMS;
            document.getElementById('tenMS').value = tenMS;

            var form = document.getElementById('updateForm');
            form.action = '/mau-sac/update/' + idMS;
        });
    });
