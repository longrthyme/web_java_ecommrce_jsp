...
<div class="container">
    ...
    <div class="main-content"id="content">
        ...
        <div class="content">
            ...
            <form id="resetForm" action="/khach-hang/search" method="get" class="d-flex justify-content-between mb-4">
                ...
                <table class="table table-hover" id="customerTable">
                    ...
                    <c:forEach items="${data}" var="kh">
                        <tr>
                            ...
                            <td>
                                <a href="update/${kh.id}" data-bs-toggle="tooltip" title="Chỉnh sửa">
            ...
            <div class="pagination-container mt-4">
                <nav aria-label="Page navigation">
                    ...
                    <div class="pagination-info" title="Trang ${currentPage} của ${totalPages}">
                        <span class="pagination-tooltip">Bạn đang ở trang ${currentPage} / ${totalPages}</span>
                    </div>
                </nav>
            </div>
        </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // Hiển thị submenu cạnh icon khi sidebar thu gọn
        <%--menuItems.forEach(function (item) {--%>
        ...
        <%--                submenu.style.left = '120px'; // Điều chỉnh vị trí submenu bên cạnh sidebar--%>
