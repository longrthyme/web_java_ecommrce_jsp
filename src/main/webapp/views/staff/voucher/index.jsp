...
<div class="container">
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="menu-section">
            ...
            <ul class="menu">
                ...
                <li><a href="/staff/khach-hang/index"><i class="fas fa-user"></i> <span>Khách Hàng</span></a></li>
                <li class="active"><a href="/staff/voucher/index"><i class="fas fa-tags"></i> <span>Phiếu Giảm Giá</span></a></li>
    ...
    <div class="main-content"id="content">
        ...
        <div class="content">
            ...
            <form id="resetForm" action="/staff/voucher/search" method="get" class="d-flex justify-content-between mb-4">
                <div class="flex-grow-1 pe-2">
                    <input type="text" name="maVc" class="form-control" placeholder="Nhập mã voucher" value="${maVc}">
                </div>
                <div class="pe-2">
            ...
            <table class="table table-hover">
                <thread style="background-color: #e3f2fd; color: #000; font-weight: bold;">
                <tr>
                    <th scope="col">ID</th>
                    <th scope="col">Mã</th>
                    <th scope="col">Tên</th>
                ...
                <c:forEach var="voucher" items="${vouchers}">
                    <tr>
                        ...
                        <!-- Định dạng giá trị -->
                        <td><fmt:formatNumber value="${voucher.giaTri}" type="number" maxFractionDigits="0" /></td>
                        <td>${voucher.loaiGiamGia}</td>
                        <!-- Định dạng giá trị tối thiểu -->
                        <td><fmt:formatNumber value="${voucher.giaTriToiThieu}" type="number" maxFractionDigits="0" /></td>
                        <td>
                            <c:choose>
                            <c:when test="${voucher.trangThai}"><span class="badge bg-success">Hoạt động</span></c:when>
                            <c:otherwise><span class="badge bg-danger">Hết hạn</c:otherwise>
                            </c:choose>
                        </td>
                        <td>
                            <a href="changeStatus/${voucher.id}" data-bs-toggle="tooltip" title="Thay đổi trạng thái">
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center">
                        <c:if test="${currentPage > 1}">
                            <a href="?page=${currentPage - 1}&size=10&ma=${ma}&trangThai=${trangThai}">Trước</a>
                        </c:if>
                        <c:forEach begin="1" end="${totalPages}" var="i">
                            <a href="?page=${i}&size=10&ma=${ma}&trangThai=${trangThai}"
                               class="${i == currentPage ? 'active' : ''}">
                                    ${i}
                            </a>
                        </c:forEach>
                        <c:if test="${currentPage < totalPages}">
                            <a href="?page=${currentPage + 1}&size=10&ma=${ma}&trangThai=${trangThai}">Tiếp</a>
                        </c:if>
                    </ul>
...
<script>
    ...
    function resetForm() {
        document.querySelector('input[name="maVc"]').value = '';
        document.querySelector('select[name="trangThai"]').value = '';

        window.location.href = '/staff/voucher/index';
    }
</script>
<!-- Bootstrap JS -->
