...
<div class="container">
    ...
    <div class="main-content"id="content">
        <div class="content d-flex flex-column align-items-center">
            ...
            <form:form method="post" modelAttribute="voucher" action="/voucher/update/${voucher.id}" class="w-50">
                ...
                <input type="text" id="giaTri" name="giaTri" value="${giaTriFormatted}" /><br/>
                ...
                <label for="giaTriToiThieu">Giá trị giảm:</label>
                <input type="text" id="giaTriToiThieu" name="giaTriToiThieu" value="${giaTriToiThieuFormatted}" /><br>

                <label for="trangThai">Trạng thái:</label>
                <select id="trangThai" name="trangThai">
                    <option value="true" ${voucher.trangThai ? 'selected' : ''}>Hoạt động</option>
                    <option value="false" ${!voucher.trangThai ? 'selected' : ''}>Hết hạn</option>
                </select>
