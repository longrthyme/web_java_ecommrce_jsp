...
<head>
    ...
    <script>
        function validateForm() {
            ...
            if (maNV === "" || tenNV === "" || sdt === "" || email === "" || matKhau === "") {
...
<div class="container">
    ...
    <form action="/nhan-vien/add" method="post" onsubmit="return validateForm()">
        <div class="form-group">
            <label for="maNV">Mã nhân viên</label>
            <input type="text" id="maNV" name="maNV" class="form-control" value="${nv.maNV}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="password" id="matKhau" name="matKhau" class="form-control" value="${nv.matKhau}">
        </div>
